...
<div id="mainContent">
    ...
    <header>
      ...
      <!-- hero t b -->
       ...
       <div id="vc">
	      ...
	      <input type="hidden" name="return" value="http://walkaboutmultimedia.com/ass3/mains_.php">
	      <input type="hidden" name="cancel_return" value="http://walkaboutmultimedia.com/ass3/mains_.php">
	      <input type="hidden" name="shopping_url" value="http://walkaboutmultimedia.com/ass3/mains_.php">
	      </form>
	    </div>
  ...
  <section class="mains-meals" style="background-color:#006633; padding: 10px; ">
    <div class="row" >
      <h3 style="position: relative; left: 0px; top: 5px; color: #FFFF99;">Mains</h3>
...
$sql= "SELECT name, description,  price, menuitem_id, vendor_id, category FROM menuitems  WHERE vendor_id = 10 AND category = 'Main' ORDER BY category DESC, name DESC";
